myApp.controller("superAdminController" , function($scope , $window, superAdminServices){
    ...
    if (role == "SuperAdmin") {
        ...
        $scope.updateOrganizationDetails =  function(updateOrganizationName  ,updateOrganizationUsername, updateOrganizationId ){
        ...
        $scope.UpdateOrganizationFunction=  function($event){
            $event.preventDefault(); 
            console.log($scope.updateOrganizationId , $scope.updateOrganizationUsername  , $scope.updateOrganizationName);
            ...
            superAdminServices.updateOrganization(data , function(response){
                ...
                $scope.organizationDetails.forEach(function(element){
                    if(element._id==response.data._id){
                        ...
                        element.organizationUsername  = response.data.organizationUsername ;
                    }
                })
